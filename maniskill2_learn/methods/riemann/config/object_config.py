...
def get_config():
    ...
    config.seg.lr = 1e-3
    config.seg.epoch = 500
    config.seg.voxel_size = 0.01
    config.seg.radius_threshold = 0.07
    config.seg.resume_from = "params/object_segnet.pth"
    ...
    config.mani.feature_point_radius = 0.02
    config.mani.resume_from = "params/object_maninet.pth"
