...
python maniskill2_learn/apis/run_rl.py configs/brl/keyframe_diff/rgbd.py --num-gpus 8 --env-id PegInsertionSide-v0 \
--cfg-options "replay_cfg.buffer_filenames='./demos/rigid_body/PegInsertionSide-v0/trajmslearn.keyframes.rgbd.pd_ee_delta_pose.h5" "workdir=rgbd-pd_ee_delta_pose-h128"
...
python maniskill2_learn/apis/run_rl.py configs/brl/clip/rgbd-policy-curobs.py --num-gpus 8 --env-id PickCube-v0 \
--cfg-options "replay_cfg.buffer_filenames='./demos/rigid_body/PickCube-v0/trajmslearn.rgbd.pd_ee_delta_pose.h5" "workdir=bc-policy-aux-clip-newview-curobs"
