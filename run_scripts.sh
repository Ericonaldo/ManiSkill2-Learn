...
python maniskill2_learn/apis/run_rl.py configs/brl/diff/rgbd.py --g 0 \
--cfg-options "env_cfg.env_name=PickCube-v0" "env_cfg.obs_mode=rgbd" "env_cfg.n_points=1200" \
"env_cfg.control_mode=pd_ee_delta_pose" \
"replay_cfg.buffer_filenames='./demos/rigid_body/PickCube-v0/trajmslearn.rgbd.pd_ee_delta_pose.h5" \
